...
class PoissonModel(LengthModel):
    ...
    def __init__(self, model_file, max_length = 5000, renormalize = True):
        super(PoissonModel, self).__init__()
        self.mean_lengths = np.loadtxt(model_file)
